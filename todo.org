...
#+CAPTION: Clock summary at [2018-12-24 Mon 12:19]
| Headline     | Time   |
|--------------+--------|
| *Total time* | *0:00* |
#+END:
...
** TODO Checkout page should be based on the invoice id
** TODO Wait for invoice should check to see if its in DB before waiting
** TODO Lightning button next to payment request with link
** TODO Wait for payment SSE
